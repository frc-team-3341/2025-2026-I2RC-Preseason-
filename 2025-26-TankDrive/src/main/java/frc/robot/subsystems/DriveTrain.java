...
public class DriveTrain extends SubsystemBase {
  ...
  public void tankDrive(double leftSpeed, double rightSpeed) {
    rightDriveTalon.set(rightSpeed*speed);
    leftDriveTalon.set(leftSpeed*speed);
  }
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Right Encoder Value", rightDriveTalon.getSelectedSensorPosition());
    SmartDashboard.putNumber("Left Encoder Value", rightDriveTalon.getSelectedSensorPosition());
  ...
  public void simulationPeriodic(){
    ...
    poseA = new Pose3d(new Translation3d(currentPose2d.getX(), currentPose2d.getY(), 0.0),rot3d);
    publisher.set(poseA);
